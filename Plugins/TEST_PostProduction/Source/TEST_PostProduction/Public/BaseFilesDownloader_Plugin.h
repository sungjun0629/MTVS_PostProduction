...
#include "BaseFilesDownloader_Plugin.generated.h"
...
class UBaseFilesDownloader_Plugin : public UObject
{
	GENERATED_BODY()
...
protected:
	...
	/** Internal downloader */
	TSharedPtr<class FRuntimeChunkDownloader_Plugin> RuntimeChunkDownloaderPtr;
};
